      ...
      <div className="admin-layout">
        ...
        <section className="admin-main">
          ...
          {activeTab === 'content' ? <div className="admin-content-grid">
            ...
            <section className="admin-asset-status admin-card-wide"><div><span className="admin-kicker">3D model</span><strong>Original UFirst production camera</strong><small>Desktop and mobile GLB assets drive the interactive journey</small></div><div><span className="admin-kicker">Scene surfaces</span><strong>Editable UFirst imagery</strong><small>Mapped onto physical screens inside the camera</small></div><div><span className="admin-kicker">Fallback</span><strong>Hero camera image</strong><small>Used when WebGL is unavailable or motion is reduced</small></div></section>
