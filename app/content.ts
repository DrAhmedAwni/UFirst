...
export const defaultContent: SiteContent = {
  ...
  system: {
    ...
    dashboard: image('/assets/ufirst-agency-creative-v1.png', 'UFirst creative campaign moodboard and storyboard'),
    mobile: image('/assets/ufirst-agency-social-v1.png', 'UFirst social campaigns and content calendar'),
    browser: image('/assets/ufirst-agency-brand-v1.png', 'UFirst brand identity kit and strategy board'),
  },
  services: [
    {
      number: '01',
      ...
      image: image('/assets/ufirst-agency-brand-v1.png', 'Dimensional UFirst identity kit, guidelines, and brand strategy board'),
    },
    {
      number: '02',
      ...
      image: image('/assets/ufirst-agency-creative-v1.png', 'UFirst campaign moodboard, editorial concepts, and storyboard'),
    },
    {
      number: '03',
      ...
      image: image('/assets/ufirst-agency-production-v1.png', 'UFirst cinema camera, clapperboard, and illuminated production studio'),
    },
    {
      number: '04',
      ...
      image: image('/assets/ufirst-agency-social-v1.png', 'UFirst social campaign cards and content calendar'),
    },
    {
      number: '05',
      ...
      image: image('/assets/ufirst-agency-growth-v1.png', 'UFirst audience research, conversion funnel, and growth visualization'),
    },
  ],
  industries: [
