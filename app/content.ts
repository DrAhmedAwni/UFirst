...
export const defaultContent: SiteContent = {
  ...
  experience: {
    ...
    moments: [
      ...
      { number: '03', scene: 'about', title: 'Enter the lens.', body: 'A sharper point of view gives ambitious brands a clearer lane to own. Keep moving and the next world opens.', component: 'The aperture / Enter the lens' },
      { number: '04', scene: 'doors', title: 'Open the next frame.', body: 'Beyond the optics is a world built for momentum. The threshold opens as the camera moves through it.', component: 'The doors / Cross the threshold' },
      { number: '05', scene: 'services', title: 'Make the move.', body: 'Brand, creative, production, digital, and growth work as one connected system.', component: 'The shutter / Make it move' },
      { number: '06', scene: 'work', title: 'Turn insight into work.', body: 'Ideas become real output: built for attention, remembered for a reason.', component: 'The sensor / See the signal' },
      { number: '07', scene: 'process', title: 'Build what lasts.', body: 'A disciplined process keeps the idea moving from first signal to measured momentum.', component: 'The processor / Build what lasts' },
      { number: '08', scene: 'contact', title: 'Carry it forward.', body: 'Bring the brief, the ambition, or the problem. We will find the frame worth making.', component: 'The memory / Carry it forward' },
      { number: '09', scene: 'contact', title: 'See what is possible.', body: 'The mechanism is complete. Now the viewfinder points toward the next frame: yours.', component: 'The viewfinder / Start the conversation' },
      { number: '10', scene: 'exit', title: 'Make your next bold move.', body: 'The camera returns complete. Now the next frame belongs to your brand.', component: 'The final frame / UFirst' },
    ],
  },
};
