...
export default function HomeExperience({ content }: { content: SiteContent }) {
  ...
  return (
    <main className="site-shell" data-experience="ufirst-cinematic-v4" style={{ '--pattern-image': `url('${content.backgrounds.pattern.src}')` } as CSSProperties}>
      ...
      <section className="section section-dark finale-section" aria-label="UFirst creative system finale"><div className="section-shell finale-grid"><div><p className="section-kicker">One team. Every dimension.</p><h2>All the pieces.<br /><em>One bold move.</em></h2><a className="button button-primary" href="#contact">Let’s build yours <span>↗</span></a></div><div className="finale-mark" aria-hidden="true"><span>U</span><i /><i /><i /></div></div></section>
