...
export const CINEMATIC_KEYFRAMES: CinematicKeyframe[] = [
  ...
  { progress: 0.36, scene: 'doors', position: [0, 0.1, -0.75], target: [0, 0, -3.65], fov: 40, roll: -0.004, label: 'Doors / Open the next frame' },
  { progress: 0.43, scene: 'services', position: [0, -0.1, -0.5], target: [0, 0, -4.25], fov: 48, roll: 0.006, label: 'Passage / Enter the system' },
  { progress: 0.52, scene: 'services', position: [0.8, -0.35, -0.8], target: [0, 0, -4.65], fov: 54, roll: -0.008, label: 'Shutter / Make the move' },
  { progress: 0.62, scene: 'work', position: [-1.25, 0.55, -1.2], target: [0, 0, -5.8], fov: 56, roll: 0.007, label: 'Sensor / Turn insight into work' },
  { progress: 0.72, scene: 'process', position: [1.15, -0.45, -1.8], target: [0, -0.1, -6.8], fov: 55, roll: -0.007, label: 'Processor / Build the idea' },
  { progress: 0.82, scene: 'process', position: [-1, 0.4, -2.6], target: [0, 0, -8], fov: 52, roll: 0.006, label: 'Memory / Carry it forward' },
  { progress: 0.9, scene: 'contact', position: [0.5, 0.7, -4.2], target: [0, 0.1, -9.2], fov: 46, roll: -0.006, label: 'Viewfinder / See what is possible' },
  { progress: 0.95, scene: 'contact', position: [1, 1, -6.2], target: [0, 0.1, -9.35], fov: 46, roll: 0.004, label: 'Reassembly / Bring it together' },
