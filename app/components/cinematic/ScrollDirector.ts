...
export const CINEMATIC_RANGES: Array<{ scene: CinematicSceneName; from: number; to: number; label: string }> = [
  ...
  { scene: 'about', from: 0.18, to: 0.22, label: 'Aperture / Enter the lens' },
  { scene: 'doors', from: 0.22, to: 0.39, label: 'Doors / Open the next frame' },
  { scene: 'services', from: 0.39, to: 0.52, label: 'Shutter / Make the move' },
  { scene: 'work', from: 0.52, to: 0.62, label: 'Sensor / Turn insight into work' },
  { scene: 'process', from: 0.62, to: 0.82, label: 'Processor / Build the idea' },
  { scene: 'contact', from: 0.82, to: 0.95, label: 'Viewfinder / See what is possible' },
